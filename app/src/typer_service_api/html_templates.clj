(ns typer-service-api.html-templates
  (:use [io.pedestal.app.templates :only [tfn dtfn tnodes]]))

(defmacro typer-service-api-templates
  []
  ;; Extract the 'hello' template from the template file typer-service-api.html.
  ...
  ;;
  ;; app/src/typer_service_api/rendering.cljs
  ;;
  ...
  {:typer-service-api-page (dtfn (tnodes "typer-service-api.html" "hello") #{:id})})
